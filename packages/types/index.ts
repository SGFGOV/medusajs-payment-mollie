...
export const PaymentProviderKeys = {
  ...
  ALMA: "mollie_alma",
  APPLE_PAY: "mollie_applepay",
  BACS: "mollie_bacs",
  BANCOMAT_PAY: "mollie_bancomatpay",
  BANCONTACT: "mollie_bancontact",
  BANK_TRANSFER: "mollie_banktransfer",
  BELFIUS: "mollie_belfius",
  BLIK: "mollie_blik",
  CREDIT_CARD: "mollie_creditcard",
  DIRECT_DEBIT: "mollie_directdebit",
  EPS: "mollie_eps",
  ...
  POINT_OF_SALE: "mollie_pointofsale",
